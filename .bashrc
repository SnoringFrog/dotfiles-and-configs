...
#TODO: more efficient loading of custom rcs
#I should consider moving my app/location specific tweets into separate files and linking them from there
#Maybe ~/usr/bashrcs/ ?
#Directory for environment-specific rc files
customrc_directory="${HOME}"

#Load genworth-specific bashrc
genworthrc=".genworth_bashrc"
if [ -f "$customrc_directory/$genworthrc" ] ; then
  source "$customrc_directory/$genworthrc"
fi

#Load mac-specific bashrc
#NOTE: should be loaded after aliases so ls is defined properly
macrc=".mac_bashrc"
if [ -f "$customrc_directory/$macrc" ] ; then
  source "$customrc_directory/$macrc"
fi
...
#https://github.com/Arkham/dotfiles/blob/master/bashrc
## Colored manpages
